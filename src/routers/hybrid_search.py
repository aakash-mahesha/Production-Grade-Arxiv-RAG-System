...
from src.dependencies import EmbeddingsServiceDep, OpenSearchServiceDep
...
async def hybrid_search(
    request: HybridSearchRequest, opensearch_client: OpenSearchServiceDep, embeddings_service: EmbeddingsServiceDep
) -> SearchResponse:
    """
