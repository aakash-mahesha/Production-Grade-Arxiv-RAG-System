"""Search endpoint for BM25 search using OpenSearch."""

import logging

from fastapi import APIRouter, HTTPException
from src.dependencies import OpenSearchServiceDep
...
async def search_papers(
    ...
    - Relevance (default) - BM25 score
    - Publication date (latest_papers=true) - Newest first
    """
    try:
